...
import type { AssetId, AssetSnapshot, NovelProjectSnapshot, ProjectId, RevisionId, NovelSelector } from '@deepseek-ai/dsh-experimental-novel-repository/types';
...
export type NovelContextPolicyId = 'direct-turn' | 'chapter-write' | 'selection-rewrite' | 'selection-review' | 'outline-edit' | 'chapter-review' | 'preference-learning' | 'story-state-learning';
...
export type NovelContextReason = 'explicit-material' | 'active-asset' | 'pinned-asset' | 'target-asset' | 'chapter-outline' | 'book-outline' | 'book-brief' | 'book-style' | 'story-state' | 'outline-parent' | 'outline-child' | 'draft-source' | 'final-source';
...
export interface NovelContextWorksetItemV1 extends Required<Pick<NovelReferenceInput, 'projectId' | 'assetId' | 'revisionId' | 'label'>>, Pick<NovelReferenceInput, 'selector'> {
...
export interface NovelContextPinnedItem extends Required<Pick<NovelReferenceInput, 'projectId' | 'assetId' | 'revisionId' | 'label'>>, Pick<NovelReferenceInput, 'selector'> {
...
export type NovelContextWorksetChange = {
    readonly version: 1;
    readonly workset: NovelContextWorksetV1;
} | {
    readonly version: 2;
    readonly workset: NovelContextWorksetV2;
};
