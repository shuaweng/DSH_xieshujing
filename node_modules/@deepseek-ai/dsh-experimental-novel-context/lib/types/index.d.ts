 ...
 */
export declare function foldNovelContextWorkset(events: readonly {
    readonly type: string;
    readonly data: unknown;
}[]): NovelContextWorkset | null;
