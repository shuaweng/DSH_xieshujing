...
import type { AssetId, ChangeSetId, ProjectId, PreferenceCandidateId, RevisionId, SelectionRefId, StoryStateCandidateId } from '@deepseek-ai/dsh-experimental-novel-repository/brand';
/** Closed JSON wire value; exact Asset schemas remain owned by the two registries. */
export type NovelWireValue = null | boolean | number | string | NovelWireValue[] | {
