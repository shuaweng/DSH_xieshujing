...
const MAX_DESCRIPTOR_MAX_BYTES = constants.MAX_STRING_LENGTH;
/** Project browser projection consuming the provider-neutral repository service. */
let NovelRepositoryRemote = (() => {
	let _classSuper = TypertRemoteService;
	let _instanceExtraInitializers = [];
	let _skills_decorators;
	let _replaceSkillSettings_decorators;
	let _discover_decorators;
	let _initialize_decorators;
	let _assets_decorators;
	let _reorderAssets_decorators;
	let _search_decorators;
	let _replaceContextWorkset_decorators;
	let _createAsset_decorators;
	let _deleteAsset_decorators;
	let _asset_decorators;
	let _revisions_decorators;
	let _restoreAsset_decorators;
	let _revisionFinalizations_decorators;
	let _preferenceCandidates_decorators;
	let _storyStateCandidates_decorators;
	let _finalizeChapter_decorators;
	let _acceptPreference_decorators;
	let _rejectPreference_decorators;
	let _acceptStoryState_decorators;
	let _rejectStoryState_decorators;
	let _analysisReports_decorators;
	let _scanNoAi_decorators;
	let _reviewChapter_decorators;
	let _saveAsset_decorators;
	let _captureSelection_decorators;
	let _changeSet_decorators;
	let _applyChangeSet_decorators;
	let _rejectChangeSet_decorators;
	return class NovelRepositoryRemote extends _classSuper {
		static {
			const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
			_skills_decorators = [Remote("skills")];
			_replaceSkillSettings_decorators = [Remote("replaceSkillSettings")];
			_discover_decorators = [Remote("discover")];
			_initialize_decorators = [Remote("initialize")];
			_assets_decorators = [Remote("assets")];
			_reorderAssets_decorators = [Remote("reorderAssets")];
			_search_decorators = [Remote("search")];
			_replaceContextWorkset_decorators = [Remote("replaceContextWorkset")];
			_createAsset_decorators = [Remote("createAsset")];
			_deleteAsset_decorators = [Remote("deleteAsset")];
			_asset_decorators = [Remote("asset")];
			_revisions_decorators = [Remote("revisions")];
			_restoreAsset_decorators = [Remote("restoreAsset")];
			_revisionFinalizations_decorators = [Remote("revisionFinalizations")];
			_preferenceCandidates_decorators = [Remote("preferenceCandidates")];
			_storyStateCandidates_decorators = [Remote("storyStateCandidates")];
			_finalizeChapter_decorators = [Remote("finalizeChapter")];
			_acceptPreference_decorators = [Remote("acceptPreference")];
			_rejectPreference_decorators = [Remote("rejectPreference")];
			_acceptStoryState_decorators = [Remote("acceptStoryState")];
			_rejectStoryState_decorators = [Remote("rejectStoryState")];
			_analysisReports_decorators = [Remote("analysisReports")];
			_scanNoAi_decorators = [Remote("scanNoAi")];
			_reviewChapter_decorators = [Remote("reviewChapter")];
			_saveAsset_decorators = [Remote("saveAsset")];
			_captureSelection_decorators = [Remote("captureSelection")];
			_changeSet_decorators = [Remote("changeSet")];
			_applyChangeSet_decorators = [Remote("applyChangeSet")];
			_rejectChangeSet_decorators = [Remote("rejectChangeSet")];
			__esDecorate(this, null, _skills_decorators, {
				kind: "method",
				name: "skills",
				static: false,
				private: false,
				access: {
					has: (obj) => "skills" in obj,
					get: (obj) => obj.skills
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _replaceSkillSettings_decorators, {
				kind: "method",
				name: "replaceSkillSettings",
				static: false,
				private: false,
				access: {
					has: (obj) => "replaceSkillSettings" in obj,
					get: (obj) => obj.replaceSkillSettings
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			...
			__esDecorate(this, null, _reorderAssets_decorators, {
				kind: "method",
				name: "reorderAssets",
				static: false,
				private: false,
				access: {
					has: (obj) => "reorderAssets" in obj,
					get: (obj) => obj.reorderAssets
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			...
			__esDecorate(this, null, _replaceContextWorkset_decorators, {
				kind: "method",
				name: "replaceContextWorkset",
				static: false,
				private: false,
				access: {
					has: (obj) => "replaceContextWorkset" in obj,
					get: (obj) => obj.replaceContextWorkset
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _createAsset_decorators, {
				kind: "method",
				name: "createAsset",
				static: false,
				private: false,
				access: {
					has: (obj) => "createAsset" in obj,
					get: (obj) => obj.createAsset
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			...
			__esDecorate(this, null, _asset_decorators, {
				kind: "method",
				name: "asset",
				static: false,
				private: false,
				access: {
					has: (obj) => "asset" in obj,
					get: (obj) => obj.asset
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			...
			__esDecorate(this, null, _restoreAsset_decorators, {
				kind: "method",
				name: "restoreAsset",
				static: false,
				private: false,
				access: {
					has: (obj) => "restoreAsset" in obj,
					get: (obj) => obj.restoreAsset
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _revisionFinalizations_decorators, {
				kind: "method",
				name: "revisionFinalizations",
				static: false,
				private: false,
				access: {
					has: (obj) => "revisionFinalizations" in obj,
					get: (obj) => obj.revisionFinalizations
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _preferenceCandidates_decorators, {
				kind: "method",
				name: "preferenceCandidates",
				static: false,
				private: false,
				access: {
					has: (obj) => "preferenceCandidates" in obj,
					get: (obj) => obj.preferenceCandidates
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _storyStateCandidates_decorators, {
				kind: "method",
				name: "storyStateCandidates",
				static: false,
				private: false,
				access: {
					has: (obj) => "storyStateCandidates" in obj,
					get: (obj) => obj.storyStateCandidates
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _finalizeChapter_decorators, {
				kind: "method",
				name: "finalizeChapter",
				static: false,
				private: false,
				access: {
					has: (obj) => "finalizeChapter" in obj,
					get: (obj) => obj.finalizeChapter
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _acceptPreference_decorators, {
				kind: "method",
				name: "acceptPreference",
				static: false,
				private: false,
				access: {
					has: (obj) => "acceptPreference" in obj,
					get: (obj) => obj.acceptPreference
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _rejectPreference_decorators, {
				kind: "method",
				name: "rejectPreference",
				static: false,
				private: false,
				access: {
					has: (obj) => "rejectPreference" in obj,
					get: (obj) => obj.rejectPreference
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _acceptStoryState_decorators, {
				kind: "method",
				name: "acceptStoryState",
				static: false,
				private: false,
				access: {
					has: (obj) => "acceptStoryState" in obj,
					get: (obj) => obj.acceptStoryState
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _rejectStoryState_decorators, {
				kind: "method",
				name: "rejectStoryState",
				static: false,
				private: false,
				access: {
					has: (obj) => "rejectStoryState" in obj,
					get: (obj) => obj.rejectStoryState
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _analysisReports_decorators, {
				kind: "method",
				name: "analysisReports",
				static: false,
				private: false,
				access: {
					has: (obj) => "analysisReports" in obj,
					get: (obj) => obj.analysisReports
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _scanNoAi_decorators, {
				kind: "method",
				name: "scanNoAi",
				static: false,
				private: false,
				access: {
					has: (obj) => "scanNoAi" in obj,
					get: (obj) => obj.scanNoAi
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _reviewChapter_decorators, {
				kind: "method",
				name: "reviewChapter",
				static: false,
				private: false,
				access: {
					has: (obj) => "reviewChapter" in obj,
					get: (obj) => obj.reviewChapter
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			...
			__esDecorate(this, null, _captureSelection_decorators, {
				kind: "method",
				name: "captureSelection",
				static: false,
				private: false,
				access: {
					has: (obj) => "captureSelection" in obj,
					get: (obj) => obj.captureSelection
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _changeSet_decorators, {
				kind: "method",
				name: "changeSet",
				static: false,
				private: false,
				access: {
					has: (obj) => "changeSet" in obj,
					get: (obj) => obj.changeSet
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _applyChangeSet_decorators, {
				kind: "method",
				name: "applyChangeSet",
				static: false,
				private: false,
				access: {
					has: (obj) => "applyChangeSet" in obj,
					get: (obj) => obj.applyChangeSet
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _rejectChangeSet_decorators, {
				kind: "method",
				name: "rejectChangeSet",
				static: false,
				private: false,
				access: {
					has: (obj) => "rejectChangeSet" in obj,
					get: (obj) => obj.rejectChangeSet
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
		...
		descriptorMaxBytes = __runInitializers(this, _instanceExtraInitializers);
		responseMaxBytes;
		...
		*/
		async skills(agent, signal) {
			const registry = this.ctx.get("skills");
			if (registry === void 0) throw new Error("novel repository remote: Skill registry is unavailable");
			...
			const descriptor = {
				version: 1,
				skills: snapshot.skills.filter((skill) => skill.source === "custom").map((skill) => ({
					name: skill.name,
		...
		*/
		async replaceSkillSettings(agent, request, signal) {
			...
			if (unknown !== void 0) throw new TypeError(`novel repository remote: unknown Novel Preset Skill ${JSON.stringify(unknown)}`);
			const project = await this.requireProject(agent, signal);
			await this.ctx.novelRepository.replaceSkillSettings(project, {
				version: 1,
		...
		*/
		async initialize(agent, request, signal) {
			const root = await this.rootFor(agent, signal);
			const descriptor = projectDescriptor(await this.ctx.novelRepository.discoverProject(root, signal) ?? await this.ctx.novelRepository.initializeProject(root, request, signal, this.ctx.sandboxPolicy.resolve({ session: agent.session })));
			assertResponseBytes(descriptor, this.descriptorMaxBytes, "project descriptor");
			return descriptor;
		}
		/**
		...
		*/
		async assets(agent, signal) {
			const project = await this.requireProject(agent, signal);
			const assets = (await this.ctx.novelRepository.listAssets(project, signal, this.ctx.sandboxPolicy.resolve({ session: agent.session }))).map((summary) => ({
				id: summary.asset.id,
				projectId: summary.asset.projectId,
				type: summary.asset.type,
				...summary.asset.parentId === void 0 ? {} : { parentId: summary.asset.parentId },
		...
		*/
		async reorderAssets(agent, request, signal) {
			const project = await this.requireProject(agent, signal);
			const descriptors = (await this.ctx.novelRepository.reorderAssets(project, {
				type: request.type,
				orderedAssetIds: request.orderedAssetIds
			}, signal, this.ctx.sandboxPolicy.resolve({ session: agent.session }))).map((summary) => ({
				id: summary.asset.id,
				projectId: summary.asset.projectId,
				type: summary.asset.type,
				...summary.asset.parentId === void 0 ? {} : { parentId: summary.asset.parentId },
		...
		*/
		async search(agent, request, signal) {
			const project = await this.requireProject(agent, signal);
			const descriptors = (await this.ctx.novelRepository.searchAssets(project, {
				query: request.query,
				...request.types === void 0 ? {} : { types: request.types },
				...request.limit === void 0 ? {} : { limit: request.limit }
			}, signal, this.ctx.sandboxPolicy.resolve({ session: agent.session }))).map(({ summary, excerpt, score }) => ({
				id: summary.asset.id,
				projectId: summary.asset.projectId,
				type: summary.asset.type,
				...summary.asset.parentId === void 0 ? {} : { parentId: summary.asset.parentId },
		...
		*/
		async replaceContextWorkset(agent, workset, signal) {
			const resolver = this.ctx.get("novelContextResolver");
			if (resolver === void 0) throw new Error("Novel context workset capability is not composed");
			const descriptor = await resolver.replaceWorkset(agent, workset, signal);
		...
		*/
		async createAsset(agent, request, signal) {
			const project = await this.requireProject(agent, signal);
			const result = assetDocument(await this.ctx.novelRepository.createAsset(project, {
				type: request.type,
				title: request.title,
		...
		*/
		async deleteAsset(agent, request, signal) {
			const project = await this.requireProject(agent, signal);
			const result = await this.ctx.novelRepository.deleteAsset(project, request, signal, this.ctx.sandboxPolicy.resolve({ session: agent.session }));
			const descriptor = {
		...
		*/
		async asset(agent, assetId, revisionId, signal) {
			const project = await this.requireProject(agent, signal);
			const result = assetDocument(await this.ctx.novelRepository.readAsset(project, assetId, revisionId ?? void 0, signal, this.ctx.sandboxPolicy.resolve({ session: agent.session })));
			assertResponseBytes(result, this.responseMaxBytes, "Asset document");
			return result;
		}
		/**
		...
		*/
		async revisions(agent, assetId, signal) {
			const project = await this.requireProject(agent, signal);
			await this.ctx.novelRepository.listAssets(project, signal, this.ctx.sandboxPolicy.resolve({ session: agent.session }));
			const revisions = (await this.ctx.novelRepository.listAssetRevisions(project, assetId, signal)).map((value) => ({
				id: value.id,
				projectId: value.projectId,
				assetId: value.assetId,
				...value.parentRevisionId === void 0 ? {} : { parentRevisionId: value.parentRevisionId },
				contentHash: value.contentHash,
				origin: value.origin,
				createdAt: value.createdAt,
				...value.restoredFromRevisionId === void 0 ? {} : { restoredFromRevisionId: value.restoredFromRevisionId },
				...value.restoredBySessionId === void 0 ? {} : { restoredBySessionId: value.restoredBySessionId }
			}));
		...
		*/
		async restoreAsset(agent, request, signal) {
			const project = await this.requireProject(agent, signal);
		...
		*/
		async revisionFinalizations(agent, assetId, signal) {
			const project = await this.requireProject(agent, signal);
			const values = (await this.ctx.novelRepository.listRevisionFinalizations(project, assetId, signal)).map(finalizationDescriptor);
		...
		*/
		async preferenceCandidates(agent, assetId, finalRevisionId, signal) {
			const project = await this.requireProject(agent, signal);
			const values = (await this.ctx.novelRepository.listPreferenceCandidates(project, assetId, finalRevisionId, signal)).map(preferenceCandidateDescriptor);
		...
		*/
		async storyStateCandidates(agent, assetId, finalRevisionId, signal) {
			const project = await this.requireProject(agent, signal);
			const values = (await this.ctx.novelRepository.listStoryStateCandidates(project, assetId, finalRevisionId, signal)).map(storyStateCandidateDescriptor);
		...
		*/
		async finalizeChapter(agent, assetId, revisionId, signal) {
			...
			const result = {
				...
				...value.candidate === void 0 ? {} : { candidate: preferenceCandidateDescriptor(value.candidate) },
				...value.noCandidateReason === void 0 ? {} : { noCandidateReason: value.noCandidateReason },
				...value.storyCandidate === void 0 ? {} : { storyCandidate: storyStateCandidateDescriptor(value.storyCandidate) },
				...value.noStoryCandidateReason === void 0 ? {} : { noStoryCandidateReason: value.noStoryCandidateReason },
				...value.storyCandidateError === void 0 ? {} : { storyCandidateError: value.storyCandidateError }
			};
		...
		*/
		async acceptPreference(agent, candidateId, signal) {
		...
		*/
		async rejectPreference(agent, candidateId, signal) {
			const result = { candidate: preferenceCandidateDescriptor(await this.ctx.novelAnalysis.rejectPreference(agent, candidateId, signal)) };
		...
		* @returns terminal candidate and browser-safe applied ChangeSet.
		*/
		async acceptStoryState(agent, candidateId, signal) {
		...
		*/
		async rejectStoryState(agent, candidateId, signal) {
			const result = { candidate: storyStateCandidateDescriptor(await this.ctx.novelAnalysis.rejectStoryState(agent, candidateId, signal)) };
		...
		*/
		async analysisReports(agent, assetId, revisionId, signal) {
			const project = await this.requireProject(agent, signal);
			const reports = (await this.ctx.novelRepository.listAnalysisReports(project, assetId, revisionId, signal)).map(analysisReportDescriptor);
		...
		*/
		async scanNoAi(agent, assetId, revisionId, signal) {
		...
		* @returns the upserted browser-safe report.
		*/
		async reviewChapter(agent, assetId, revisionId, signal) {
		...
		*/
		async saveAsset(agent, request, signal) {
			const project = await this.requireProject(agent, signal);
			const result = assetDocument(await this.ctx.novelRepository.saveAssetContent(project, {
				assetId: request.assetId,
				baseRevisionId: request.baseRevisionId,
		...
		*/
		async captureSelection(agent, request, signal) {
			const project = await this.requireProject(agent, signal);
			...
			const result = {
				...
				...selection.preview === void 0 ? {} : { preview: selection.preview },
				mention: formatNovelReferenceMention({
					projectId: selection.projectId,
					assetId: selection.assetId,
					revisionId: selection.revisionId,
					selector: selection.selector,
					label: selection.preview === void 0 ? selection.assetId : selection.preview
				})
			};
		...
		*/
		async changeSet(agent, changeSetId, signal) {
			const project = await this.requireProject(agent, signal);
		...
		*/
		async applyChangeSet(agent, changeSetId, signal) {
			const project = await this.requireProject(agent, signal);
			const result = changeSetDescriptor(await this.ctx.novelRepository.applyChangeSet(project, changeSetId, { sessionId: agent.id }, signal, this.ctx.sandboxPolicy.resolve({ session: agent.session })));
			assertResponseBytes(result, this.responseMaxBytes, "ChangeSet");
			return result;
		}
		/**
		...
		*/
		async rejectChangeSet(agent, changeSetId, signal) {
			const project = await this.requireProject(agent, signal);
			const result = changeSetDescriptor(await this.ctx.novelRepository.rejectChangeSet(project, changeSetId, { sessionId: agent.id }, signal));
			assertResponseBytes(result, this.responseMaxBytes, "ChangeSet");
			return result;
		}
		async projectFor(agent, signal) {
			const root = await this.rootFor(agent, signal);
			return await this.ctx.novelRepository.discoverProject(root, signal);
		}
		async rootFor(agent, signal) {
			const cwd = agent.session.header.cwd;
			if (cwd === void 0) throw new NovelRepositoryError(`novel repository remote: agent session "${agent.id}" has no working directory`, "NOVEL_PROJECT_ROOT_INVALID");
			return await this.ctx.fs.resolve(cwd, { signal });
		}
		async requireProject(agent, signal) {
			const project = await this.projectFor(agent, signal);
			if (project === void 0) throw new NovelRepositoryError(`novel repository remote: agent session "${agent.id}" is not rooted at a Novel Project`, "NOVEL_PROJECT_ROOT_INVALID");
			return project;
		}
	};
})();
function validateByteBound(name, value) {
	if (!Number.isSafeInteger(value) || value < 1 || value > MAX_DESCRIPTOR_MAX_BYTES) throw new Error(`novel-repository-remote: ${name} must be an integer between 1 and ${MAX_DESCRIPTOR_MAX_BYTES}`);
}
function assertResponseBytes(value, maxBytes, subject) {
	if (new TextEncoder().encode(JSON.stringify(value)).byteLength > maxBytes) throw new NovelRepositoryError(`novel repository remote: ${subject} exceeds ${maxBytes} bytes`, subject === "project descriptor" ? "NOVEL_PROJECT_DESCRIPTOR_TOO_LARGE" : "NOVEL_RESPONSE_TOO_LARGE");
}
function assetDocument(snapshot) {
	const novel = snapshot.frontmatter["novel"];
	const title = typeof novel === "object" && novel !== null && !Array.isArray(novel) ? Reflect.get(novel, "title") : void 0;
	if (typeof title !== "string") throw new NovelRepositoryError("novel repository remote: Asset title is missing", "NOVEL_HISTORY_CORRUPT");
	return {
		id: snapshot.asset.id,
		projectId: snapshot.asset.projectId,
		type: snapshot.asset.type,
		...snapshot.asset.parentId === void 0 ? {} : { parentId: snapshot.asset.parentId },
...
function changeSetDescriptor(value) {
	return {
		id: value.id,
		projectId: value.projectId,
		assetId: value.assetId,
		...
		status: value.status,
		...value.resultRevisionId === void 0 ? {} : { resultRevisionId: value.resultRevisionId },
		operations: value.operations.map((operation) => wireValue(operation, "ChangeSet operation"))
	};
}
function analysisReportDescriptor(value) {
	return {
		projectId: value.projectId,
		assetId: value.assetId,
		...
		...value.sourceSessionId === void 0 ? {} : { sourceSessionId: value.sourceSessionId },
		...value.workerSessionId === void 0 ? {} : { workerSessionId: value.workerSessionId }
	};
}
function finalizationDescriptor(value) {
	return {
		projectId: value.projectId,
		assetId: value.assetId,
		revisionId: value.revisionId,
		...
		...value.sourceRevisionId === void 0 ? {} : { sourceRevisionId: value.sourceRevisionId },
		...value.sourceChangeSetId === void 0 ? {} : { sourceChangeSetId: value.sourceChangeSetId },
		...value.sourceSessionId === void 0 ? {} : { sourceSessionId: value.sourceSessionId }
	};
}
function preferenceCandidateDescriptor(value) {
	return {
		id: value.id,
		projectId: value.projectId,
		assetId: value.assetId,
...
function storyStateCandidateDescriptor(value) {
	return {
		id: value.id,
		projectId: value.projectId,
		assetId: value.assetId,
...
function wireValue(value, subject, ancestors = /* @__PURE__ */ new Set(), depth = 0) {
	if (depth > 64) throw new NovelRepositoryError(`novel repository remote: ${subject} is nested too deeply`, "NOVEL_HISTORY_CORRUPT");
	...
	if (typeof value !== "object") throw new NovelRepositoryError(`novel repository remote: ${subject} is not lossless JSON`, "NOVEL_HISTORY_CORRUPT");
	if (ancestors.has(value)) throw new NovelRepositoryError(`novel repository remote: ${subject} is cyclic`, "NOVEL_HISTORY_CORRUPT");
	ancestors.add(value);
	try {
		if (Array.isArray(value)) return value.map((item) => wireValue(item, subject, ancestors, depth + 1));
		const prototype = Object.getPrototypeOf(value);
		if (prototype !== Object.prototype && prototype !== null) throw new NovelRepositoryError(`novel repository remote: ${subject} has a non-JSON object`, "NOVEL_HISTORY_CORRUPT");
		const output = Object.create(null);
		for (const [key, item] of Object.entries(value)) Object.defineProperty(output, key, {
			configurable: true,
			enumerable: true,
...
function projectDescriptor(project) {
	return {
		...
		id: project.id,
		title: project.title,
		...project.description === void 0 ? {} : { description: project.description },
		rootDisplayPath: project.root.displayPath,
		manifestDisplayPath: project.manifest.displayPath,
		contentRootDisplayPaths: Object.fromEntries(Object.entries(project.contentRoots).map(([name, target]) => [name, target.displayPath]))
	};
}
//#endregion
export { NovelRepositoryRemote, NovelRepositoryRemote as default };
