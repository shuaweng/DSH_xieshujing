...
import type { NovelAssetDocument, NovelContextWorksetDescriptor, NovelProjectDescriptor } from '@deepseek-ai/dsh-experimental-novel-repository-remote/types';
...
export declare class NovelContextFocusController {
    #private;
    /** Return the last detached focus fact for React external-store reads. */
    readonly getSnapshot: () => NovelContextFocus | undefined;
...
export declare class NovelLibraryContextFocusController {
    #private;
    /** Return the latest detached library-home surface. */
    readonly getSnapshot: () => NovelLibraryContextFocus | undefined;
...
export declare class NovelProjectStatusController {
    #private;
    /** Return the last detached project readiness fact for React external-store reads. */
    readonly getSnapshot: () => NovelProjectStatusFocus | undefined;
    /** Subscribe one listener until its returned disposer is called. */
    readonly subscribe: (listener: () => void) => (() => void);
    /**
