...
import type { NovelAssetDescriptor, NovelAssetDocument, NovelProjectDescriptor, NovelWireValue } from '@deepseek-ai/dsh-experimental-novel-repository-remote/types';
 ...
 */
export declare function createNovelWorkbenchStore(): EngineStoreHandle<NovelWorkbenchState, Actions>;
export {};
