...
import type { AssetId, ChangeSetId, ProjectId, PreferenceCandidateId, RevisionId, SelectionRefId, StoryStateCandidateId } from './brand.ts';
export type { AssetId, ChangeSetId, ProjectId, PreferenceCandidateId, RevisionId, SelectionRefId, StoryStateCandidateId, } from './brand.ts';
/**
...
export type NovelSelectorFor<Input extends NovelSelectionInput> = Extract<NovelSelector, {
...
export type NovelRepositoryErrorCode = 'NOVEL_PROJECT_ROOT_INVALID' | 'NOVEL_PROJECT_INITIALIZATION_INVALID' | 'NOVEL_PROJECT_ALREADY_INITIALIZED' | 'NOVEL_PROJECT_CONTENT_ROOT_CONFLICT' | 'NOVEL_PROJECT_MANIFEST_INVALID' | 'NOVEL_PROJECT_MANIFEST_TOO_LARGE' | 'NOVEL_PROJECT_DESCRIPTOR_TOO_LARGE' | 'NOVEL_RESPONSE_TOO_LARGE' | 'NOVEL_PROJECT_SCHEMA_UNSUPPORTED' | 'NOVEL_PROJECT_PATH_ESCAPE' | 'NOVEL_PROJECT_ID_CONFLICT' | 'NOVEL_ASSET_INVALID' | 'NOVEL_ASSET_TOO_LARGE' | 'NOVEL_ASSET_DUPLICATE_ID' | 'NOVEL_ASSET_NOT_FOUND' | 'NOVEL_ASSET_CHANGED_DURING_SCAN' | 'NOVEL_HISTORY_SCHEMA_UNSUPPORTED' | 'NOVEL_HISTORY_CORRUPT' | 'NOVEL_REVISION_NOT_FOUND' | 'NOVEL_REVISION_STALE' | 'NOVEL_SELECTION_INVALID' | 'NOVEL_SEARCH_INVALID' | 'NOVEL_CHANGESET_NOT_FOUND' | 'NOVEL_CHANGESET_INVALID' | 'NOVEL_CHANGESET_CONFLICT' | 'NOVEL_CHANGESET_UNAUTHORIZED' | 'NOVEL_FINALIZATION_INVALID' | 'NOVEL_PREFERENCE_CANDIDATE_NOT_FOUND' | 'NOVEL_PREFERENCE_CANDIDATE_INVALID' | 'NOVEL_STORY_STATE_CANDIDATE_NOT_FOUND' | 'NOVEL_STORY_STATE_CANDIDATE_INVALID';
