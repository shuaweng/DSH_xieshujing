...
import type { AssetId, AssetSnapshot, AssetRevisionSummary, AssetSummary, AssetSearchResult, CaptureSelectionRequest, CreateAssetRequest, DeleteAssetRequest, DeleteAssetResult, InitializeNovelProjectRequest, ChangeSet, ChangeSetAuthorization, ChangeSetId, NovelProjectSnapshot, NovelAnalysisReport, NovelSelectionInput, NovelSkillSettings, PutNovelAnalysisReportRequest, PutNovelPreferenceCandidateRequest, NovelPreferenceCandidate, PreferenceCandidateId, NovelStoryStateCandidate, PutNovelStoryStateCandidateRequest, StoryStateCandidateId, RevisionFinalization, ReorderAssetsRequest, RestoreAssetRevisionRequest, RestoreAssetRevisionResult, ProposeChangeSetRequest, RevisionId, SaveAssetContentRequest, SearchAssetsRequest, SelectionRef } from './types.ts';
export { AssetId, ChangeSetId, PreferenceCandidateId, ProjectId, RevisionId, SelectionRefId, StoryStateCandidateId, } from './brand.ts';
export { NovelRepositoryError };
export type { Asset, AssetRevision, AssetRevisionSummary, AssetSnapshot, AssetSummary, AssetSearchResult, CaptureSelectionRequest, CreateAssetRequest, DeleteAssetRequest, DeleteAssetResult, InitializeNovelProjectRequest, ChangeSet, ChangeSetAuthorization, ContentHash, ManuscriptChapterContent, NovelAssetContent, NovelAssetType, NovelAssetTypeMap, NovelAnalysisReport, NovelAnalysisReportKind, NovelPreferenceCandidate, NovelPreferenceCandidateStatus, NovelPreferenceEvidence, NovelGenerationLineage, NovelStoryStateCandidate, NovelStoryStateCandidateStatus, NovelStoryStateEvidence, NovelOperation, NovelSelectionInput, NovelSkillSettings, NovelSelector, NovelSelectorFor, NovelProjectSnapshot, NovelRepositoryErrorCode, ProposeChangeSetRequest, PutNovelAnalysisReportRequest, PutNovelPreferenceCandidateRequest, PutNovelStoryStateCandidateRequest, InsertTextOperation, UpdateTitleOperation, ReplaceTextOperation, RevisionOrigin, RevisionFinalization, RestoreAssetRevisionRequest, RestoreAssetRevisionResult, ReorderAssetsRequest, SaveAssetContentRequest, SearchAssetsRequest, SelectionRef, TextRangeSelectionInput, TextRangeSelector, } from './types.ts';
...
export declare abstract class NovelRepository extends Service {
     ...
     */
    decidePreferenceCandidate(project: NovelProjectSnapshot, candidateId: PreferenceCandidateId, decision: 'accepted' | 'rejected', decidedBySessionId: import('@deepseek-ai/dsh-session/types').SessionId, result?: {
     ...
     */
    decideStoryStateCandidate(project: NovelProjectSnapshot, candidateId: StoryStateCandidateId, decision: 'accepted' | 'rejected', decidedBySessionId: import('@deepseek-ai/dsh-session/types').SessionId, result?: {
        readonly changeSetId: ChangeSetId;
        readonly revisionId: RevisionId;
