...
flowchart TD
  ...
  pkg_experimental_novel_analysis --> pkg_tool_skill
  ...
  pkg_experimental_novel_repository_remote --> pkg_skill
  pkg_experimental_novel_repository_remote --> pkg_tool_skill
  ...
  pkg_experimental_tool_novel --> pkg_user_approval
  pkg_experimental_tool_novel --> pkg_user_questions
  ...
  pkg_experimental_novel_asset_outline --> pkg_client_ui_primitives
