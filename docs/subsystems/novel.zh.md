...
写书鲸子系统在不改变通用 Agent Loop 的前提下增加文件化 Novel Project 领域。[`novel-repository`](../../packages/experimental/novel-repository/README.zh.md) 拥有稳定的 Project、Asset、Revision、Selection 与 ChangeSet 身份；[`novel-context`](../../packages/experimental/novel-context/README.zh.md) 编译显式、可重放的模型上下文；[`novel-analysis`](../../packages/experimental/novel-analysis/README.zh.md) 拥有精确 Revision 分析与显式定稿学习；[`novel-repository-remote`](../../packages/experimental/novel-repository-remote/README.zh.md) 暴露浏览器安全的传输边界。文件格式、校验、限制与组合方式由各包 README 负责。
...
Types: [FsTarget](filesystem.zh.md) · [SandboxExecutionPolicy](sandbox.zh.md) · [SessionId](core.zh.md)
