...
| [novel.md](novel.md) | the WriteBookWhale Novel Project domain: typed Assets, immutable Revisions, reviewable ChangeSets, exact context manifests, analysis, and browser transport |
