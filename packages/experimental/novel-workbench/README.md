...
- The shipped manuscript renderer edits a chapter body, captures UTF-16 ranges, counts non-whitespace authored characters, and opts into paper-color, typeface, and font-size controls.
