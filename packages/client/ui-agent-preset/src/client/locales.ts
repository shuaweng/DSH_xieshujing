...
export const en: Record<AgentPresetSettingsKey, string> = {
  ...
  presetNovelDescription:
    'Webnovel and long-form fiction writing agent with filesystem, search, shell, subagents, goals, compaction, novel-writing skills, style-context injection, and post-write style/snapshot guards.',
  duplicate: 'Duplicate',
...
export const zh: Record<AgentPresetSettingsKey, string> = {
  ...
  presetNovelDescription: '面向中文网文与长篇小说的创作 Agent：保留文件读写/搜索/子代理/压缩等通用能力，去掉 LSP、Code Mode、工作流等编程特化能力，内置小说 skills、风格指纹注入与写后 AI 味/快照护栏。',
  duplicate: '复制',
