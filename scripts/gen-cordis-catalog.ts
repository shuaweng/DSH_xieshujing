...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  novelAssetTypes: 'novel-workbench.md',
  novelAnalysis: 'novel-workbench.md',
  novelContextResolver: 'novel-workbench.md',
  novelRepository: 'novel-workbench.md',
  novelRepositoryRemote: 'novel-workbench.md',
  novelStudioPaths: 'novel-workbench.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  agentPresetSelection: 'client-side read-only blank-session preset snapshot — packages/client/ui-agent-preset/README.md owns the API',
  ...
  novelAssetRenderers: 'client-side interface-typed asset renderer registry — packages/experimental/novel-workbench/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  AssetId: 'novel-workbench.md',
  AssetRevisionSummary: 'novel-workbench.md',
  AssetSearchResult: 'novel-workbench.md',
  AssetSnapshot: 'novel-workbench.md',
  AssetSummary: 'novel-workbench.md',
  CaptureNovelSelectionRequest: 'novel-workbench.md',
  CaptureSelectionRequest: 'novel-workbench.md',
  ChangeSet: 'novel-workbench.md',
  ChangeSetAuthorization: 'novel-workbench.md',
  ChangeSetId: 'novel-workbench.md',
  CreateAssetRequest: 'novel-workbench.md',
  CreateNovelAssetRequest: 'novel-workbench.md',
  NovelAssetDocument: 'novel-workbench.md',
  NovelAssetDescriptor: 'novel-workbench.md',
  NovelAssetRevisionDescriptor: 'novel-workbench.md',
  NovelAssetSearchResult: 'novel-workbench.md',
  NovelAssetTypeDefinition: 'novel-workbench.md',
  NovelChapterDocument: 'novel-workbench.md',
  NovelChangeSetDescriptor: 'novel-workbench.md',
  NovelAnalysisReport: 'novel-workbench.md',
  NovelAnalysisReportDescriptor: 'novel-workbench.md',
  NovelProjectDescriptor: 'novel-workbench.md',
  NovelProjectSnapshot: 'novel-workbench.md',
  NovelContextWorkset: 'novel-workbench.md',
  NovelContextWorksetDescriptor: 'novel-workbench.md',
  NovelCandidateAnalysisWarning: 'novel-workbench.md',
  NovelOperation: 'novel-workbench.md',
  ...
  PutNovelAnalysisReportRequest: 'novel-workbench.md',
  ProjectId: 'novel-workbench.md',
  ResolvedNovelReferences: 'novel-workbench.md',
  RevisionId: 'novel-workbench.md',
  SaveAssetContentRequest: 'novel-workbench.md',
  SaveChapterBodyRequest: 'novel-workbench.md',
  SaveNovelAssetRequest: 'novel-workbench.md',
  SaveNovelChapterRequest: 'novel-workbench.md',
  SearchAssetsRequest: 'novel-workbench.md',
  SearchNovelAssetsRequest: 'novel-workbench.md',
  SelectionRef: 'novel-workbench.md',
