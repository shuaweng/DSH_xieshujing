...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  novelAnalysis: 'novel.md',
  novelAssetTypes: 'novel.md',
  novelContextResolver: 'novel.md',
  novelRepository: 'novel.md',
  novelRepositoryClientReady: 'novel.md',
  novelRepositoryRemote: 'novel.md',
  novelStudioPaths: 'novel.md',
  novelWorkbenchReady: 'novel.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  novelAssetRenderers: 'client-side typed Novel Asset renderer registry — packages/experimental/novel-workbench/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  Agent: 'core.md',
  AssetId: 'novel.md',
  AssetRevisionSummary: 'novel.md',
  AssetSearchResult: 'novel.md',
  AssetSnapshot: 'novel.md',
  AssetSummary: 'novel.md',
  CaptureNovelSelectionRequest: 'novel.md',
  CaptureSelectionRequest: 'novel.md',
  ChangeSet: 'novel.md',
  ChangeSetAuthorization: 'novel.md',
  ChangeSetId: 'novel.md',
  CompiledNovelContext: 'novel.md',
  CreateAssetRequest: 'novel.md',
  CreateNovelAssetRequest: 'novel.md',
  DecideNovelPreferenceDescriptor: 'novel.md',
  DecideNovelStoryStateDescriptor: 'novel.md',
  DeleteAssetRequest: 'novel.md',
  DeleteAssetResult: 'novel.md',
  DeleteNovelAssetDescriptor: 'novel.md',
  DeleteNovelAssetRequest: 'novel.md',
  FinalizeChapterResult: 'novel.md',
  FinalizeNovelChapterDescriptor: 'novel.md',
  InitializeNovelProjectRequest: 'novel.md',
  NovelAnalysisReport: 'novel.md',
  NovelAnalysisReportDescriptor: 'novel.md',
  NovelAssetDescriptor: 'novel.md',
  NovelAssetDocument: 'novel.md',
  NovelAssetRevisionDescriptor: 'novel.md',
  NovelAssetSearchResult: 'novel.md',
  NovelAssetTypeDefinition: 'novel.md',
  NovelCandidateAnalysisWarning: 'novel.md',
  NovelChangeSetDescriptor: 'novel.md',
  NovelContextCompileRequest: 'novel.md',
  NovelContextWorkset: 'novel.md',
  NovelContextWorksetDescriptor: 'novel.md',
  NovelContextWorksetV2: 'novel.md',
  NovelOperation: 'novel.md',
  NovelPreferenceCandidate: 'novel.md',
  NovelPreferenceCandidateDescriptor: 'novel.md',
  NovelProjectDescriptor: 'novel.md',
  NovelProjectSnapshot: 'novel.md',
  NovelReferenceInput: 'novel.md',
  NovelRevisionFinalizationDescriptor: 'novel.md',
  NovelSelectionDescriptor: 'novel.md',
  NovelSelectionInput: 'novel.md',
  NovelSkillSettings: 'novel.md',
  NovelSkillSettingsDescriptor: 'novel.md',
  NovelStoryStateCandidate: 'novel.md',
  NovelStoryStateCandidateDescriptor: 'novel.md',
  PreferenceCandidateId: 'novel.md',
  PreparedNovelMessage: 'novel.md',
  ProposeChangeSetRequest: 'novel.md',
  PutNovelAnalysisReportRequest: 'novel.md',
  PutNovelPreferenceCandidateRequest: 'novel.md',
  PutNovelStoryStateCandidateRequest: 'novel.md',
  ReorderAssetsRequest: 'novel.md',
  ReorderNovelAssetsRequest: 'novel.md',
  ReplaceNovelSkillSettingsRequest: 'novel.md',
  ResolvedNovelReferences: 'novel.md',
  RestoreAssetRevisionRequest: 'novel.md',
  RestoreAssetRevisionResult: 'novel.md',
  RestoreNovelAssetDescriptor: 'novel.md',
  RestoreNovelAssetRequest: 'novel.md',
  RevisionFinalization: 'novel.md',
  RevisionId: 'novel.md',
  SaveAssetContentRequest: 'novel.md',
  SaveNovelAssetRequest: 'novel.md',
  SearchAssetsRequest: 'novel.md',
  SearchNovelAssetsRequest: 'novel.md',
  SelectionRef: 'novel.md',
  StoryStateCandidateId: 'novel.md',
